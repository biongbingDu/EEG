...
lstm_size = 150         # 3 times the amount of channels
...
with graph.as_default():
    ...
    print('112222222222222222222222')
    print(lstm_in.shape)
    lstm_in = tf.reshape(lstm_in, [-1, n_ch]) # Now (seq_len*N, n_channels)
    print('11333333333333333333')
    print(lstm_in.shape)
    # To cells
    lstm_in = tf.layers.dense(lstm_in, lstm_size, activation=None) # or tf.nn.relu, tf.nn.sigmoid, tf.nn.tanh?
    print('11777777777777777777777')
    print(lstm_in.shape)
...
with graph.as_default():
    ...
    print('136666666666666666666666')
    print(outputs)
    print(final_state)
