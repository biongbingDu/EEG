...
print ("Training data shape: steps = {:d}, channels = {:d}".format(X_train.shape[0],X_train.shape[1]))
print ("Test data shape: steps = {:d}, channels = {:d}".format(X_test.shape[0],X_test.shape[1]))
